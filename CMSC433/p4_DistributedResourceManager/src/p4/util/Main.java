...
public class Main {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		ArrayList<NodeSpecification> nodes = setupUserTest1();
	...
	private static ArrayList<NodeSpecification> setupUserTest1 () throws FileNotFoundException {
		// Create initial resources
		
		ArrayList<Resource> printers = Systems.makeResources("Printer", 1);
		
		// Create user scripts
		UserScript script1 = UserScript.fromFile("usertest1script1.txt");
		UserScript script2 = UserScript.fromFile("usertest1script4.txt");
		...
		ArrayList<UserScript> scriptList2 = new ArrayList<UserScript>();
		scriptList2.add(script2);
		NodeSpecification node2 = new NodeSpecification(new ArrayList<Resource>(), scriptList2);
