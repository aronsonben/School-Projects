...
public abstract class PMQuadtree {
	...
	public class Black extends Node {
		...
		public Node add(final Geometry g, final Point2D.Float origin,
			...
			if (isValid()) {
				System.out.println(g.toString()+" is valid");
		...
		/**
		 * Picks the roads out of the geometry list, return null if none exist
		 * @return an ArrayList of roads contained within this city
		 */
