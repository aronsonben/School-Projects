...
public class MeeshQuest {
	 ...
	 */
	private static final boolean LOCAL_TEST = false; 			// TODO: change back to 'false' before submission
    ...
    public void processInput() {
        ...
        try {
            ...
            // Printing adjacency list after processing all commands
            /*for(String s : command.adjList.keySet()) {
            	System.out.println(s+": "+command.adjList.get(s));
            }*/
	...
	private void processCommand(final Element commandNode) throws IOException {
		...
		// TODO: command list 			System.out.println("yo");
